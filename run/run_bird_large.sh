...
CUDA_VISIBLE_DEVICES=0 python train_bird.py --seed 1 --cfg experiment/T5_large_finetune_bird.cfg \
...
--save_total_limit 1 --load_best_model_at_end --gradient_accumulation_steps 1 --num_train_epochs 200 \
